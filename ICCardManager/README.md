...
| バージョン | 日付 | 内容 |
|------------|------|------|
| 1.2.0 | 2026-02-04 | 職員証認証機能追加、バージョン表示、履歴詳細の表示順修正、インストーラー常駐オプション |
| 1.1.0 | 2026-02-03 | 機能追加（残高整合性チェック、スクリーンショットツール）、マニュアル改善 |
| 1.0.8 | 2026-02-01 | ドキュメント整備（配布手順書のインストーラー対応、機能設計書の修正） |
