...
/// 本テストはカスタム書式下で SQL 5 箇所（集計除外 3 クエリ・繰越先頭ソート 2 クエリ）と
/// 購入日取得が生成側と揃って動くことを実 SQLite で固定する（購入日取得は Issue #2046 以降、
/// SQL ではなく <see cref="Ledger.IsInitialRecordSummary"/> で導入行を判定する）。
/// </para>
/// <para>
