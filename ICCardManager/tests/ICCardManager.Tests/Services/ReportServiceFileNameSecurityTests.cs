...
/// <summary>
/// Issue #1703: <see cref="ReportFileNameFactory"/> が、CardType / CardNumber に
...
public class ReportServiceFileNameSecurityTests
{
    ...
    {
        var fileName = new ReportFileNameFactory().GetFiscalYearFileName(cardType, cardNumber, 2024);
    ...
    {
        var fileName = new ReportFileNameFactory().GetFiscalYearFileName("はやかけん", "H001", 2024);
