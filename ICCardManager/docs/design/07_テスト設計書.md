...
| 2 | 無音で通常トースト再表示（別職員） | Aでタッチ後、Bの職員証タッチ | Play呼出なし、ShowStaffRecognizedNotification("Bさん") が1回呼ばれる、ShowWarning は呼ばれない |
| 3 | 状態維持 | Aでタッチ後、Bの職員証タッチ | CurrentState=WaitingForIcCard（ICカード待ち継続） |
| 4 | 無音・無通知（同一職員） | Aでタッチ後、再度Aの職員証タッチ | Play/ShowStaffRecognizedNotification/ShowWarning いずれも呼ばれず状態維持 |
