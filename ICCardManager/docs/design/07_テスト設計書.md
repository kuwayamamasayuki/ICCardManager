...
| 2 | 認識音 | Aでタッチ後、Bの職員証タッチ | Play(SoundType.Notify)呼出（エラー音ではない） |
| 3 | 認識通知 | Aでタッチ後、Bの職員証タッチ | ShowStaffRecognizedNotification("Bさん") |
| 4 | 状態維持 | Aでタッチ後、Bの職員証タッチ | CurrentState=WaitingForIcCard（ICカード待ち継続） |
| 5 | 同一職員再タッチ無音化 | Aでタッチ後、再度Aの職員証タッチ | 無音・無通知・状態維持（操作ノイズ抑制） |
