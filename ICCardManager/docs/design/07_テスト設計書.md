...
| 23 | **プレビューで全フィールド同一は Skip**（Issue #1370） | 既存カードと全フィールド同一の CSV, skipExisting=false | SkipCount=1, Action=Skip |
| 24 | **プレビューで Note null と空文字は同一扱い**（Issue #1370） | 既存 Note=null, CSV 備考列空 | SkipCount=1, Action=Skip, Changes に「備考」を含まない |
...
| 26 | **職員プレビューで全フィールド同一は Skip**（Issue #1370） | 既存職員と全フィールド同一の CSV, skipExisting=false | SkipCount=1, Action=Skip |
