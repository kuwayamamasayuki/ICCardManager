...
| 2 | 無音・無通知（別職員） | Aでタッチ後、Bの職員証タッチ | 音・トーストともに出ない（Play/ShowWarning/ShowStaffRecognizedNotification いずれも呼ばれない） |
| 3 | 状態維持 | Aでタッチ後、Bの職員証タッチ | CurrentState=WaitingForIcCard（ICカード待ち継続） |
| 4 | 無音・無通知（同一職員） | Aでタッチ後、再度Aの職員証タッチ | 音・トーストともに出ず状態維持（操作ノイズ抑制） |
