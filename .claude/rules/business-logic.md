...
|----------|--------|
| 単純片道 | 鉄道（A駅～B駅） |
| 往復 | 鉄道（A駅～B駅 往復） ※往復の復路は次の移動へ乗継統合しない。往復2組（A→B、B→A、C→D、D→C）は「鉄道（A駅～B駅 往復、C駅～D駅 往復）」（復路が乗換駅グループ経由で次の往路と統合され往復表記が失われていた、Issue #1902）。**往復ペアの端点照合は同一視グループを考慮する**（行きと帰りで乗降場所の名前が違う往復も往復として検出する。余りの経路の算出も同じ正規化を通さないと復路が重複表示になる、Issue #1905） |
| 乗継 | 鉄道（A駅～C駅） ※途中駅省略 |
| 複数区間 | 鉄道（A駅～B駅、C駅～D駅） |
